...
namespace Business
{
    #region GroupItemChina
    /// <summary>
    /// This object represents the properties and methods of a GroupItemChina.
    /// </summary>
    public class GroupItemChina
    {
        protected int m_Id;
        ...
        public GroupItemChina()
        {
        }

        public GroupItemChina(int id)
        {
            m_Id = id;
        }
