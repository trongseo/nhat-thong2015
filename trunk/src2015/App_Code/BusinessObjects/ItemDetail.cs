...
namespace Business
{
    #region ItemDetail
    /// <summary>
    /// This object represents the properties and methods of a ItemDetail.
    /// </summary>
    public class ItemDetail
    {
        protected int m_Id;
        protected int m_GroupItemId;
        ...
        private GroupItem objGroupItem;
        ...
        public GroupItem GroupItem
        {
            get
            {
                if (objGroupItem == null)
                    objGroupItem = GroupItemManager.GetGroupItem(m_GroupItemId);
                return objGroupItem;
            }
            set
            {
                if (value != null)
                    m_GroupItemId = value.Id;
                else
                    m_GroupItemId = 0;
            }
        }
